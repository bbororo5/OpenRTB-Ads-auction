...
import com.bbororo.rtb.dsp.campaignruntime.CampaignRuntimeMessages.Campaign;
...
import com.bbororo.rtb.dsp.campaignruntime.CampaignRuntimeMessages.Creative;
import com.bbororo.rtb.dsp.campaignruntime.CampaignRuntimeMessages.RankCampaigns;
import com.bbororo.rtb.dsp.campaignruntime.CampaignRuntimeMessages.SnapshotInstallResult;
...
@DisplayName("캠페인 선택기(CampaignRuntime) 스냅샷 적재 및 역색인 구축 단위 테스트")
class DefaultCampaignRuntimeTest {
    ...
    private DefaultCampaignRuntime selector;

    @BeforeEach
    void setUp() {
        selector = new DefaultCampaignRuntime();
    }
    ...
    void pacingLagDescendingOrdering() {
        ...
        var pacingSelector = new DefaultCampaignRuntime(pacingSource);
