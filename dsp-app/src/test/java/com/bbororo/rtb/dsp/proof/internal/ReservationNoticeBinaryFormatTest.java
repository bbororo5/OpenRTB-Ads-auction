...
class ReservationNoticeBinaryFormatTest {
    ...
    void roundTripPreservesAllClaimsAcrossAllNoticeKinds(ReservationNoticeKind kind) {
    ...
    @Test
    @DisplayName("유효성 검증: 정의되지 않은 잘못된 ReservationNoticeKind ordinal 값(99)은 디코딩 시 거절된다")
