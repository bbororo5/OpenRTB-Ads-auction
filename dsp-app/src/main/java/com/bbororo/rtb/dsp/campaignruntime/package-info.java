 ...
 *   <li><b>페이싱 기반 순위화:</b> {@link com.bbororo.rtb.dsp.campaignruntime.CampaignPacingSource}를 통해 1차 {@code pacingLagPpm} 내림차순, 2차 {@code campaignId} 오름차순으로 결정론적(Deterministic) 정렬을 수행합니다.</li>
 * </ul>
 *
 * <h2>2. 핵심 컴포넌트 구조</h2>
 * <pre>
 ...
 * </pre>
 *
 * @see com.bbororo.rtb.dsp.campaignruntime.CampaignRuntime
 * @see com.bbororo.rtb.dsp.campaignruntime.DefaultCampaignRuntime
 * @see com.bbororo.rtb.dsp.campaignruntime.CampaignPacingSource
 * @see com.bbororo.rtb.dsp.campaignruntime.SlotDimensionPacker
 * @see com.bbororo.rtb.dsp.campaignruntime.CampaignRuntimeMessages
 */
