 ...
 */
public final class DefaultCampaignRuntime implements CampaignRuntime {
    ...
    public DefaultCampaignRuntime() {
        this((campaignId, evaluatedAt) -> 0L);
    }

    public DefaultCampaignRuntime(CampaignPacingSource pacingSource) {
