...
상태: 얇은 수직 흐름 0~5단계 완료 · 컴포넌트 강화 4단계 완료
...
| 5 | DSP 통지 전달 | 임대·재시도·기한·늦은 작업자 결과 방어 | 다음 |
| 6 | 경매 중복 방지 | 만료·충돌·동시 최초 실행, 최종 응답·증표 재사용과 메모리 상한 | 대기 |
| 7 | 경매 조정 | 절대 기한과 부분 실패 아래 전체 결과 조립 | 대기 |
| 8 | 경매·렌더링 API | 외부 오류 표현·요청 제한·실행 경계 | 대기 |
